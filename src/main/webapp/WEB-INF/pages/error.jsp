        ...
        <div class="layui-row">
            <div class="layui-col-md-offset4 layui-col-md4" style="margin-top: 30px;margin-bottom: 50px;">
                ...
                <form class="layui-form" action="${ctx}\room\list">
                    <h1 class="layui-input-block">预约失败！<i class="layui-icon layui-icon-face-cry" style="font-size: 30px; color: #1E9FFF;"></i></h1>
                    <div class="layui-form-item">您当前预定信息的是:该房型已无库存！</div>
                    <br>
                    <br>
